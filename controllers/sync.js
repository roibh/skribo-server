...
let Sync = class Sync {
    static post_accounts(groupId, accounts) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield user_account_model_1.UserAccountModel.delete({ GroupId: groupId }, user_account_model_1.UserAccountModel, false);
                const accountsList = JSON.parse(accounts.accounts);
                accountsList.forEach((element) => __awaiter(this, void 0, void 0, function* () {
                    const account = new user_account_model_1.UserAccountModel({
    ...
    static get_accounts(groupId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const query = new data_1.Query(user_account_model_1.UserAccountModel);
