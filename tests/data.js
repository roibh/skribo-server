...
exports.ReportResultEmbededCopy = { "reportType": "embeded", "results": { "Leibish": [], "פספורטכארד מכר": [], "AllJobs": [], "Walla!Shops": [], "z-Dr Stephan": [], "Aviation Links - Domestic": [], "Olga Raz Method": [], "z-ediamonds-oldest": [], "Neurim": [], "Manpower": [], "יוניסף": [], "Ruppin AC -Yam": [], "YamOnline": [] } };
exports.ReportResultCollection = {
